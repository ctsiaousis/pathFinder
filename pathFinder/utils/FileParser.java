...
//		System.out.println(items);
		Road mRoad = new Road(items.get(0), items.get(1), items.get(2), Integer.parseInt(items.get(3)));
		return mRoad;
	}
	...
	public boolean parse(String filePath, Setup mySetup) {
		try {
			...
			int startingSymbol = 0, endingSymbol = 0; // source=1 , destination=2 , roads=3 , prediction=4
														// day=5 , actualTrafficPerDay=6
